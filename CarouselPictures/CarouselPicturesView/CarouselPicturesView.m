...
+ (instancetype)carouselPicturesViewWithFrame:(CGRect)frame WithImageUrls:(NSArray<NSString *> *)imageUrl {
    return  [[CarouselPicturesView alloc] initWithFrame:frame WithImageNames:imageUrl];
}
...
- (void)prepareScrollView {
    UIScrollView *sc = [[UIScrollView alloc] initWithFrame:self.frame];
    [self addSubview:sc];
